            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="profile-main-content">
                        ...
                        <!-- dodati formu ovjde -> laravel tutor na yt 1:51:10 -->
                        <div class="write-post-area">
                        <div class="write-area">
                            <img src="{{asset('assets/images/profile/profile-user-sm.png')}}" alt="">
                    ...
                    <div class="profile-single-post">
                        ...
                        <div class="p-s-p-content">
                            ...
                            <img src="{{asset('assets/images/profile/s-p-img1.jpg')}}" alt="">
                        </div>
                        <div class="p-s-p-content-footer">
                            <div class="left">
                                <a href="#" class="comment">Comment</a>
